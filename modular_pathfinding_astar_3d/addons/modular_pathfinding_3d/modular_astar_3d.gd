...
func find_path(graph: PathfindingGraph3D, start_id: Variant, goal_id: Variant, options := {}) -> PackedVector3Array:
...
func find_point_path(graph: PathfindingGraph3D, start_id: Variant, goal_id: Variant, options := {}) -> Array:
	last_iterations = 0
